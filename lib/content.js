...
const successStories = [
  {
    slug: "cyprus-spring-2026-approvals",
    student: "Spring 2026 cohort",
    program: "Cyprus Admissions Pathway",
    title: "Seven students approved for Cyprus pathways",
    result: "Admissions and visa preparation completed for Spring 2026",
    quote:
      "ASA kept every document, deadline, and counselor update clear from the first consultation.",
    story:
      "The Spring 2026 Cyprus cohort moved through university selection, admission processing, and visa documentation with counselor-led checklists and family updates.",
    metrics: ["7 recent approvals", "2 Cyprus institutions", "2 dedicated counselors"]
  }
];
...
export async function getSuccessStories() {
  return fetchData(successStories);
}
