        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-line bg-white shadow-plush">
          <div className="relative min-h-[360px] sm:min-h-[420px] xl:min-h-[480px]">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-espresso via-espresso/95 to-transparent p-6 sm:bg-gradient-to-t sm:from-espresso/95 sm:via-espresso/70 sm:to-transparent sm:p-10">
              ...
              <h1 className="max-w-4xl text-4xl font-bold leading-[1.14] text-white [text-shadow:0_2px_16px_rgba(0,0,0,0.55)] sm:text-[2.75rem] lg:text-[3.15rem] xl:text-[3.25rem]">
                {program.title}
              </h1>
